...
//-----------------------------------------------------------------------
// <copyright file="HotelReservationDetails.cs" company="Klarna AB">
...
namespace Klarna.Rest.Models.EMD
{
    ...
    /// </summary>
    public class HotelReservationDetails : Model
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("hotel_itinerary")]
        public List<HotelItinerary> Itineraries { get; set; }
