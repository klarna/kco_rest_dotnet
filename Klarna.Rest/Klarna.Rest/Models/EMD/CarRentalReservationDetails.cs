...
//-----------------------------------------------------------------------
// <copyright file="CarRentalReservationDetails.cs" company="Klarna AB">
...
namespace Klarna.Rest.Models.EMD
{
    ...
    /// </summary>
    public class CarRentalReservationDetails : Model
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("car_rental_itinerary")]
        public List<CarRentalItinerary> Itineraries { get; set; }
        ...
        /// <summary>
        /// Gets or sets the list of drivers.
        /// </summary>
