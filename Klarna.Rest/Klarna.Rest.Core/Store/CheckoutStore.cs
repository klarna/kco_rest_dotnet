...
namespace Klarna.Rest.Core.Store
{
    ...
    {
        internal CheckoutStore(ApiSession apiSession, IJsonSerializer jsonSerializer) : base(apiSession, ApiControllers.Checkout, jsonSerializer) { }

        /// <summary>
        /// Use this API call to create a new order. 
        /// <a href="https://developers.klarna.com/api/#checkout-api-create-a-new-order">https://developers.klarna.com/api/#checkout-api-create-a-new-order</a>
        /// </summary>
