...
namespace Klarna.Rest.Core
{
    ...
    public class Klarna
    {
        ...
        /// <a href="https://developers.klarna.com/api/#checkout-api">https://developers.klarna.com/api/#checkout-api</a>
        /// </summary>
        ...
        /// As soon as the purchase is completed the order should be read and handled using the Order Management API.
        /// <a href="https://developers.klarna.com/api/#payments-api">https://developers.klarna.com/api/#payments-api</a>
        /// </summary>
        ...
        /// <a href="https://developers.klarna.com/api/#order-management-api">https://developers.klarna.com/api/#order-management-api</a>
        /// </summary>
        ...
        /// <a href="https://developers.klarna.com/api/#settlements-api">https://developers.klarna.com/api/#settlements-api</a>
        /// </summary>
        ...
        /// <a href="https://developers.klarna.com/api/#customer-token-api">https://developers.klarna.com/api/#customer-token-api</a>
        /// </summary>
        ...
        /// <a href="https://developers.klarna.com/api/#hosted-payment-page-api">https://developers.klarna.com/api/#hosted-payment-page-api</a>
        /// </summary>
        ...
        /// <a href="https://developers.klarna.com/api/#merchant-card-service-api-virtual-credit-card-settlements">https://developers.klarna.com/api/#merchant-card-service-api-virtual-credit-card-settlements</a>
        /// </summary>
        ...
        /// </summary>
        /// <param name="username">Consists of your Merchant ID (eid) - a unique number that identifies your e-store, combined with a random string.</param>
        /// <param name="password">a string which is associated with your Merchant ID and is used to authorize use of Klarna's APIs</param>
        /// <param name="environment">The API is accessible through a few different URLS. There are different URLs for testing and for making live purchases as well as different URLs for depending on if you are based in Europe or in the U.S.</param>
        /// <param name="userAgent">The user agent string used when calling the Klarna API</param>
        public Klarna(string username, string password, KlarnaEnvironment environment, string userAgent = "") : this(username, password, ApiUrlFromEnvironment(environment), userAgent) { }
        ...
        /// <param name="environment">The API is accessible through a few different URLS. There are different URLs for testing and for making live purchases as well as different URLs for depending on if you are based in Europe or in the U.S.</param>
        /// <param name="userAgent">The user agent string used when calling the Klarna API</param>
        public Klarna(ApiCredentials credentials, KlarnaEnvironment environment, string userAgent = "") : this(new ApiSession { ApiUrl = ApiUrlFromEnvironment(environment), UserAgent = userAgent, Credentials = credentials }) { }
        ...
        /// <param name="username">Consists of your Merchant ID (eid) - a unique number that identifies your e-store, combined with a random string.</param>
        /// <param name="password">a string which is associated with your Merchant ID and is used to authorize use of Klarna's APIs</param>
        /// <param name="apiUrl">The API is accessible through a few different URLS. There are different URLs for testing and for making live purchases as well as different URLs for depending on if you are based in Europe or in the U.S.</param>
        /// <param name="userAgent">The user agent string used when calling the Klarna API</param>
        public Klarna(string username, string password, string apiUrl, string userAgent = "") : this(new ApiSession { ApiUrl = apiUrl, UserAgent = userAgent, Credentials = new ApiCredentials{Username = username, Password = password}}) { }
        ...
        /// <param name="apiUrl">The API is accessible through a few different URLS. There are different URLs for testing and for making live purchases as well as different URLs for depending on if you are based in Europe or in the U.S.</param>
        /// <param name="userAgent">The user agent string used when calling the Klarna API</param>
        public Klarna(ApiCredentials credentials, string apiUrl, string userAgent = "") : this(new ApiSession { ApiUrl = apiUrl, UserAgent = userAgent, Credentials = credentials}) { }
