...
/**
 * Test cases for TrainReservationDetails
 */
@RunWith(MockitoJUnitRunner.class)
public class TrainReservationDetailsTest extends TestCase {

    TrainReservationDetails object;

    @Before
    public void setUp() {
        this.object = new TrainReservationDetails();
    }
