...
/**
 * Test cases for the FerryReservationDetails class.
 */
@RunWith(MockitoJUnitRunner.class)
public class FerryReservationDetailsTest extends TestCase {

    FerryReservationDetails object;

    @Before
    public void setUp() {
        this.object = new FerryReservationDetails();
    }
