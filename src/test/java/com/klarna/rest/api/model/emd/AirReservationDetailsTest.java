...
/**
 * Test class for the AirReservationDetails class.
 */
@RunWith(MockitoJUnitRunner.class)
public class AirReservationDetailsTest extends TestCase {

    private AirReservationDetails object;

    @Before
    public void setUp() {
        this.object = new AirReservationDetails();
    }
