...
/**
 * The model for train reservation details.
 */
public class TrainReservationDetails extends Model {
    /**
     * PNR.
     */
    private String pnr;
     ...
     */
    public TrainReservationDetails setPnr(final String pnr) {
        this.pnr = pnr;
     ...
     * @return Same instance.
     */
    public TrainReservationDetails setItinerary(
     ...
     * @return Same instance.
     */
    public TrainReservationDetails setInsurance(
     ...
     * @return Same instance.
     */
    public TrainReservationDetails setPassengers(
     ...
     * @return Same instance.
     */
    public TrainReservationDetails setAffiliateName(
