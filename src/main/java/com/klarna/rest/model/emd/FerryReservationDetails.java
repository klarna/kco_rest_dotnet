...
/**
 * The model for ferry reservation details.
 */
public class FerryReservationDetails extends Model {
    /**
     * PNR.
     */
    private String pnr;
     ...
     */
    public FerryReservationDetails setPnr(final String pnr) {
        this.pnr = pnr;
     ...
     * @return Same instance.
     */
    public FerryReservationDetails setItinerary(
     ...
     * @return Same instance.
     */
    public FerryReservationDetails setInsurance(
     ...
     * @return Same instance.
     */
    public FerryReservationDetails setPassengers(
     ...
     * @return Same instance.
     */
    public FerryReservationDetails setAffiliateName(
