...
public class OrderManagementRefund {
    ...
    private List<OrderManagementOrderLine> processedOrderLines = null;
     ...
     **/
    @ApiModelProperty(value = "Order lines for the refund shown to the customer. Optional but increases the customer experience. Maximum 1000 order lines.")
    public List<OrderManagementOrderLine> getProcessedOrderLines() {
        return processedOrderLines;
    }

    public void setProcessedOrderLines(List<OrderManagementOrderLine> orderLines) {
        this.processedOrderLines = processedOrderLines;
    }

    public OrderManagementRefund processedOrderLines(List<OrderManagementOrderLine> processedOrderLines) {
        this.processedOrderLines = processedOrderLines;
        return this;
    }

    public OrderManagementRefund addProcessedOrderLinesItem(OrderManagementOrderLine processedOrderLinesItem) {
        if (this.processedOrderLines == null) {
            this.processedOrderLines = new ArrayList<OrderManagementOrderLine>();
        }
